export const dataHome = [
	{
		...
		"description": "Votre maison loin de chez vous. Que vous veniez de l'autre bout du monde, ou juste de quelques stations de RER, vous vous retrouverez chez vous dans notre appartement.",
		"hôte": {
			"nom": "Nathalie Jean",
			"photo": "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-12.jpg"
		},
		"note": "5",
	...
	},
	{
		...
		"hôte": {
			"name": "Della Case",
			"photo": "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-1.jpg"
		},
		"note": "4",
	...
	},
	{
		...
		"hôte": {
			"nom": "Franck Maher",
			"photo": "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-2.jpg"
		},
		"note": "3",
	...
	},
	{
		...
		"hôte": {
			"name": "Ligne Rolland",
			"photo": "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-3.jpg"
		},
		"note": "5",
	...
	},
	{
		...
		"description": "Ce Studio entièrement fonctionnel sera votre parfait pied à terre pour toutes vos excursions parisiennes. Idéalement situé près des lignes 2 et 4, vous accédez très rapidement à tous les points touristiques de Paris.",
		"hôte": {
			"nom": "Hugo Perrier",
			"photo": "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-4.jpg"
		},
		"note": "3",
		"location": "Île de France - Paris 18e",
		"équipements": [
	...
	},
	{
		...
		"description": "Ce superbe appartement vous surprendra par son charme. Entièrement refait à neuf, il est équipé avec goût. La taille des pièces vous fera douter que vous soyez à Paris. Mais il vous suffit de sortir pour voir que vous êtes au coeur des plus belles attractions de Paris : le Louvre, la Tour Eiffel, le Grand Palais sont à deux pas. À vous de venir découvrir Paris !",
		"hôte": {
			"name": "Sébastien Fournier",
			"photo": "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-5.jpg"
		},
		"note": "5",
		"location": "Île de France - Paris 6e",
		"équipements": [
			"Wifi",
			"Sèche Cheveux",
			"Machine à laver",
	...
	},
	{
		...
		"description": "Paris vous tendez les bras ! En famille ou entre amis, venez découvrir la ville de l'amour dans un appartement de goût. Vous pourrez profiter de tous les commerces à seulement quelques minutes de l'appartement. Sa proximité avec la gare Montparnasse en fait également un choix idéal pour celles et ceux qui doivent prendre un train.",
		"hôte": {
			"nom": "Adrien Chiran",
			"photo": "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-6.jpg"
		},
		"note": "4",
		"location": "Île de France - Paris 14e",
		"équipements": [
			"Climatisation",
			"Machine à laver",
			"Sèche Cheveux",
	...
	},
	{
		...
		"hôte": {
			"nom": "Victor Moran",
			"photo": "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-7.jpg"
		},
		"note": "4",
		"location": "Île de France - Paris 11e",
		"équipements": [
	...
	},
	{
		...
		"hôte": {
			"nom": "Sarah Devit",
			"photo": "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-8.jpg"
		},
		"note": "3",
		"location": "Île de France - Paris 3e",
		"équipements": [
			"Rangements",
			"Allumé",
			"Sèche Cheveux",
	...
	},
	{
		...
		"description": "Vous cherchez un endroit pour fêter un anniversaire entre amis tout en restant proche de Paris ? Ne cherchez plus ! Entièrement équipé, cette maison est l'endroit idéal pour se regrouper.",
		"hôte": {
			"nom": "Karen Guillet",
			"photo": "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-9.jpg"
		},
		"note": "4",
		"location": "Île de France - Arnouville",
		"équipements": [
			"SDB",
			"Cuisine équipée",
			"Frigo",
	...
	},
	{
		...
		"hôte": {
			"nom": "Julie Donatella",
			"photo": "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-10.jpg"
		},
		"note": "3",
		"localisation" : "Île de France - La Défense",
		"équipements": [
			"Baie vitrée",
			"Télévision",
			"Quatre",
	...
	},
	{
		...
		"note": "4",
		"location": "Île de France - Levallois",
		"équipements": [
			"Télévision",
			"Quatre",
			"Frigo",
	...
	},
	{
		...
		"hôte": {
			"nom": "Michel Romy",
			"photo": "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-11.jpg"
		},
		"note": "4",
		"location": "Île de France - Paris 13e",
		"équipements": [
			"Équipements de base",
			"Quatre",
			"Frigo",
